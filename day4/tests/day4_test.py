...
input_a = """ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
def test_correct_example_solution_part_a():
    assert a.return_solution(input_a) == 2


def test_correct_example_solution_for_all_valid_part_b():
    assert b.return_solution(all_valid) == 3


def test_correct_example_solution_for_all_invalid_part_b():
    assert b.return_solution(all_invalid) == 0
